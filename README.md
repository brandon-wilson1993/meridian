This is a project to build out a bnaking application for me to better understand Spring Boot and any other technologies I plan to use (Kafka, SQS, and DynamoDB come to mind right away).
