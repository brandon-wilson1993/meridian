...
public class CorsIntegrationTests extends BaseTest {
    ...
    @Test
    void postRequest_withAllowedOrigin_returnsCorsHeaders() {
        String body = """
                {
                    "username": "testuser",
                    "password": "testpass"
    ...
    @Test
    void getRequest_withAllowedOrigin_returnsCorsHeaders() {
        Response response = RestAssured.given()
                .header("Origin", "http://localhost:8000")
    ...
    @Test
    void putRequest_withAllowedOrigin_returnsCorsHeaders() {
        String body = """
                {
                    "firstName": "Updated",
                    "lastName": "User"
    ...
    @Test
    void deleteRequest_withAllowedOrigin_returnsCorsHeaders() {
        Response response = RestAssured.given()
                .header("Origin", "http://localhost:8000")
                .header("Authorization", "Bearer " + jwtToken)
                .delete("/users/999");
